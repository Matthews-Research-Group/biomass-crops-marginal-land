...
#Also NOTE: the NASA's time stamp is NOT UTC! It's the local time. No need to specify that here
...
POWERNASA_to_BioCroInputs <- function(powernasa,latitude){
  ...
  solardiff <- solar * lightME(lat=latitude,DOY=doy,t.d=powernasa$HR,t.sn=12,atm.P=1e5,alpha=0.85)$propIdiff
