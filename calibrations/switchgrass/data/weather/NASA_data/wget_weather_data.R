...
for (i in 1:dim(latlon_unique)[1]){
  ...
  url=paste0("https://power.larc.nasa.gov/api/temporal/hourly/point?Time=LST&parameters=ALLSKY_SFC_PAR_TOT,T2M,RH2M,PRECTOTCORR,WS2M&community=AG&longitude=",lon,"&latitude=",lat,"&start=20010101&end=20151231&format=CSV")
  outfile_name = paste0("NASA_powerdata_2001_2015_site_",latlon_unique$id[i],".csv")
