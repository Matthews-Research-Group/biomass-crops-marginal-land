...
guess_growing_season_start_and_end_doy = function(climate, threshold_temperature) {
    ...
    day1 = max(c(early_season_freezing_days, 1))  # The first day of the season is the last freezing day, or day 1 at the earliest.
    ...
    dayn = min(c(late_season_freezing_days, 365))  # The last day of the season is the first freezing day, or day 365 at the latest.
