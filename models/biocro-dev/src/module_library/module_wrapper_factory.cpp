...
#include "incident_shortwave_par_from_cwrf.h"
#include "partitioning_growth_with_rhizome_as_reserved_c_storage.hpp"
...
module_wrapper_factory::module_wrapper_creator_map module_wrapper_factory::module_wrapper_creators =
{
     ...
     {"delta_TT",                                        &create_wrapper<delta_TT>},
     ...
     {"logistic_partitioning_with_rhizome_remobilization",    &create_wrapper<logistic_partitioning_with_rhizome_remobilization>},
     {"incident_shortwave_par_from_cwrf",                     &create_wrapper<incident_shortwave_par_from_cwrf>},
     {"miscanthus_senescence",                           &create_wrapper<miscanthus_senescence>},
     {"partitioning_growth_with_rhizome_as_reserved_c_storage",                     &create_wrapper<partitioning_growth_with_rhizome_as_reserved_c_storage>}
};
