...
class partitioning_growth_with_rhizome_as_reserved_c_storage : public SteadyModule {
    public:
        partitioning_growth_with_rhizome_as_reserved_c_storage(const std::unordered_map<std::string, double>* input_parameters, std::unordered_map<std::string, double>* output_parameters) :
            // Define basic module properties by passing its name to its parent class
            SteadyModule("partitioning_growth_with_rhizome_as_reserved_c_storage"),
...
std::vector<std::string> partitioning_growth_with_rhizome_as_reserved_c_storage::get_inputs() {
    return {
        "kLeaf",
        "kStem",
        "kRoot",
...
std::vector<std::string> partitioning_growth_with_rhizome_as_reserved_c_storage::get_outputs() {
    return {
        "newLeafcol",
        "newStemcol",
        "newRootcol",
